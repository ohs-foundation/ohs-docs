...
[The architecture](/ohs-player/architecture/) shows how these components connect through the gateway and draws the line between Player and the wider Open Health Stack.
