...
**Anything ordered or scheduled.** Due, overdue, and expired states are workflow rather than presentation. Configuration can show a date; deciding what that date means about the work is a different concern.
