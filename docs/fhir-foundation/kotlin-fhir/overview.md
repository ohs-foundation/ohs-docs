...
Kotlin FHIR is the base of the FHIR Foundation stack. It provides the HL7 FHIR data model, every resource and data type, generated as minimalistic and idiomatic Kotlin classes, together with `kotlinx.serialization` serializers that read and write spec-compliant FHIR JSON. It covers FHIR R4, R4B, and R5, each as its own artifact.
