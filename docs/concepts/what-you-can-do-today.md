...
**Extraction is template-based.** StructureMap-based extraction is a roadmap item; template-based extraction using FHIRPath covers the reference use case today.
