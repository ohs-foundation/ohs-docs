...
guide_focus: OHS Player reference toolkit
...
[How to get started](/ohs-player/setups/)
...
The [OHS Foundation Projects page](https://ohs.foundation/projects) is the component catalogue and source of maturity information. This section explains only how Player repositories use components in a setup.

[How OHS Player uses OHS components](/ohs-player/concepts/how-player-uses-ohs-components/)
...
The [configuration concepts](/ohs-player/concepts/configuration/) explain the relationship between the Player client library and the configuration implementation guide.
