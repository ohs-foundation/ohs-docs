...
slug: /ohs-player/setups/analytics/
sidebar_position: 6
...
Complete the [shared Player environment](/ohs-player/setups/reference-infrastructure/), [Web Portal administration](/ohs-player/setups/web-portal/), and [Client App](/ohs-player/setups/client-app/) first. Return to this page when the Analytics Compose extension and runbook are available.

## Next step

[Adapt UI configuration](/ohs-player/concepts/configuration/) when the Client App needs to render data differently.
