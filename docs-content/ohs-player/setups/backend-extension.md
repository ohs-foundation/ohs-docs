...
slug: /ohs-player/setups/backend-extension/
sidebar_position: 5
...
This is part of the shared Player environment stage of the [quick start](/ohs-player/setups/). The Web Portal uses its gateway endpoint for custom APIs, and the Client App is run after the shared Player environment and Portal administration are ready.
...
[Run the Web Portal](/ohs-player/setups/web-portal/) to administer the environment before running the Client App.
