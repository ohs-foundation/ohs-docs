...
slug: /ohs-player/setups/reference-infrastructure/
sidebar_position: 4
...
For a local Portal evaluation, [Run the Web Portal](/ohs-player/setups/web-portal/). Its Docker Compose setup starts HAPI FHIR, Keycloak, and a development gateway. For Player-specific gateway APIs, [add the Reference Backend extensions](/ohs-player/setups/backend-extension/).
