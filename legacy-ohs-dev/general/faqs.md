---
title: "Frequently Asked Questions  |  Open Health Stack  |  Google for Developers"
original_url: "https://developers.google.com/open-health-stack/faqs"
source: "ohs.dev (Google for Developers Open Health Stack)"
---

# Frequently Asked Questions  |  Open Health Stack  |  Google for Developers
...
- Open Health Stack (OHS) is an open-source initiative led by Google, providing tools and guidelines for building digital health solutions based on the FHIR standard.
- OHS simplifies FHIR adoption for developers, particularly in resource-constrained environments, offering features like offline capabilities through the Android FHIR SDK.
- It supports a variety of healthcare programs and integrates with WHO Smart Guidelines for evidence-based care delivery.
- Google does not receive, collect, store, or process any data used within applications built using OHS.
- OHS is not a managed service; developers utilize its components to build and deploy their own solutions on preferred infrastructure.

## What is Google’s role in this project?

Google led the design and development of the open source components and design
guidelines published as part of the Open Health Stack (OHS).

**Note:** As of December '25, ownership of the project has been transferred to
the Linux Foundation and we are in the process of establishing the Open Health
Stack Software Foundation with partners in the ecosystem.

If you are interested to learn more about how to join or to get involved please
reach out to [join@ohs.foundation](mailto:join@ohs.foundation)
...
IntelliSOFT Consulting, Argusoft, and a number of independent software
engineers have contributed to the codebase.
